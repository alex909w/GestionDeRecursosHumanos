    ...
    <table class="table table-bordered">
        ...
        <c:forEach var="contratacion" items="${contrataciones}">
            <tr>
                ...
                <td>${contratacion.estado ? 'Activo' : 'Inactivo'}</td> <!-- Usamos 'estado' ahora en lugar de 'gestado'. -->
                <td>
                    <a href="contrataciones?action=editar&idContratacion=${contratacion.idContratacion}" class="btn btn-warning">Editar</a>
                    <a href="contrataciones?action=eliminar&idContratacion=${contratacion.idContratacion}" class="btn btn-danger">Eliminar</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>

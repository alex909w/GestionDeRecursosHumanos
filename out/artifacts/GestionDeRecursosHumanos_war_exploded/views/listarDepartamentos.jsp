    ...
    <table class="table table-bordered">
        ...
        <c:forEach var="departamento" items="${departamentos}">
            <tr>
                ...
                <td>
                    <a href="departamentos?action=editar&idDepartamento=${departamento.idDepartamento}"
                       class="btn btn-warning">Editar</a>
                    <a href="departamentos?action=eliminar&idDepartamento=${departamento.idDepartamento}"

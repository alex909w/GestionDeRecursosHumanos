...
<div class="container mt-5">
    ...
    <form action="contrataciones" method="post">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" id="idDepartamento" name="idDepartamento"
                   value="${contratacion.idDepartamento}" required>
        </div>
        <div class="form-group">
            <label for="idEmpleado">ID Empleado:</label>
            <input type="number" class="form-control" id="idEmpleado" name="idEmpleado"
                   value="${contratacion.idEmpleado}" required>
        </div>
        <div class="form-group">
            <label for="idCargo">ID Cargo:</label>
            <input type="number" class="form-control" id="idCargo" name="idCargo" value="${contratacion.idCargo}"
                   required>
        </div>
        <div class="form-group">
            <label for="idTipoContratacion">ID Tipo Contratación:</label>
            <input type="number" class="form-control" id="idTipoContratacion" name="idTipoContratacion"
                   value="${contratacion.idTipoContratacion}" required>
        </div>
        <div class="form-group">
